...
public class JerseyHystrixCommand extends HystrixCommand<Object>{
    ...
    public JerseyHystrixCommand(final MethodInfo methodInfo, final RestClient client, final RestAdapterConfig config, final Object[] args) {
    ...
    protected Object run() throws Exception {
        ...
        final boolean isRequestCacheable = cache.isPresent() && cachingPolicy.isCachable(request);
        if (isRequestCacheable) {
            ...
            if (cachedResponse.isPresent()) {
                ...
                return restAdapterConfig.getMessageSerializer().readValue(methodInfo.getResponseClass(),
        ...
        if (HttpResponse.class.equals(methodInfo.getResponseClass())) {
            ...
            if(isRequestCacheable && cachingPolicy.isCachable(httpResponse)){
            ...
            object = restAdapterConfig.getMessageSerializer().readValue(methodInfo.getResponseClass(), inputStream);
        }
